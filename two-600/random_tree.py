...
# Disrupt the order of the data set
...
#Integrated model
estimator = RandomForestClassifier( random_state=10,n_estimators=3)
...
plt.scatter(X_pca[:, 0], X_pca[:, 1], c=y_train, edgecolors='k', s=50, cmap=cm_dark) 
# plt.scatter(X_pca2[:, 0], X_pca2[:, 1], s=120, facecolors='none', zorder=10) 
